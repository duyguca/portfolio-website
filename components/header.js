...
const Header = () => {
  ...
  return (
    <header className="z-[999] text-center relative">
      <div className="fixed border-none bottom-0 left-0 right-0 min-w-[430px] sm:left-1/2 sm:-translate-x-1/2 h-[3rem]  w-full rounded-none border  bg-gradient-to-b from-purple-400 to-pink-600 sm:top-6 sm:h-[3.25rem] sm:w-[40rem] sm:rounded-full"></div>
